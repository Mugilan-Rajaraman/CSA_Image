  ...
  public static void main(String[] args)
  {
    ...
    for(int i = 0; i < upsideDownPixels2.length; i++){
      for(int j = 0; j < upsideDownPixels2[i].length; j++){
        ...
        upsideDownpix2.setRed(upsideDownPixels2[upsideDownPixels2.length-1-i][upsideDownPixels2[i].length-1-j].getRed());
        upsideDownpix2.setGreen(upsideDownPixels2[upsideDownPixels2.length-1-i][upsideDownPixels2[i].length-1-j].getGreen());
        upsideDownpix2.setBlue(upsideDownPixels2[upsideDownPixels2.length-1-i][upsideDownPixels2[i].length-1-j].getBlue());
      } 
    }
    ...
    for(int i = 0; i < upsideDownPixels.length; i++){
      for(int j = 0; j < upsideDownPixels[i].length; j++){
        ...
        upsideDownpix.setRed(upsideDownPixels[upsideDownPixels.length-1-i][upsideDownPixels[i].length-1-j].getRed());
        upsideDownpix.setGreen(upsideDownPixels[upsideDownPixels.length-1-i][upsideDownPixels[i].length-1-j].getGreen());
        upsideDownpix.setBlue(upsideDownPixels[upsideDownPixels.length-1-i][upsideDownPixels[i].length-1-j].getBlue());
      } 
    }
